 ...
 * 
 */
public class CompletaOffTask extends Task {
	...
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			response.sendRedirect("http://gis.di.unimi.it/k1-azienda/src/offerta_riservata_correttamente.php");
		    //response.sendRedirect("http://www.metmi.it/k1_aziende/src/offerta_riservata_correttamente.php");
		} catch (IOException e) {
