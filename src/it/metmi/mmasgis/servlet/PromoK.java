...
public class PromoK extends Task {
	...
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		String k1gis_offertaK1 = "'"+k1_offerta+"'";
		...
		try {
			...
			for (int i=0; i < pvK1.size(); i++) {
				...
				//rowDataK1.put(cod_mmas, k1_gis);
				 ...
				 insert = String.format(Const.queryK1,k1_settore,pv_id,k1gis_offertaK1);
			 ...
			 updateRiservata = db.eseguiQueryK1(String.format(Const.updateK1riservata,k1gis_offertaK1),true);
		...
		session.removeAttribute("offerta");
